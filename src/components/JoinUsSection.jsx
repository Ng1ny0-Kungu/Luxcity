    ...
    <section className="relative py-16 px-6 md:px-20 bg-transparent text-white overflow-hidden flex justify-center items-center">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0492C2]">
          Ready to Discover and Grow Your Talent with Us? 🌟
        </h2>
        <p className="text-lg leading-relaxed text-gray-200">
          Whether you dream to draw, dance, or produce your own music —{" "}
          <span className="text-[#0492C2] font-semibold">Luxcity Academy</span>{" "}
          is here to guide your artistic journey.
          <br />
          <br />
          Join us and take your first step toward creative mastery! 🎨💃🎶
          <br />
          <br />
